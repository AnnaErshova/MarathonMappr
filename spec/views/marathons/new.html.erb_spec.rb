...
RSpec.describe "marathons/new", type: :view do
  before(:each) do
    assign(:marathon, Marathon.new(
      :name => "MyString",
      :city => "MyString",
      :country => "MyString",
  ...
  it "renders new marathon form" do
    render

    assert_select "form[action=?][method=?]", marathons_path, "post" do
